...
import { Camera, AlignCenter, MessageSquare, BrainCircuit } from "lucide-react";
...
const SAMPLE_TEXT = "This is a sample text that will be displayed when the image is clicked. In a real application, this could be information extracted from the image or any other relevant content.";
...
export default function Home() {
  ...
  const handleAlignmentChange = (newAlignment: { top: number; right: number; bottom: number; left: number }) => {
